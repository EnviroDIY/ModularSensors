...
KellerNanoParent::KellerNanoParent(byte modbusAddress, Stream* stream,
...
String KellerNanoParent::getSensorLocation(void)
{
...
bool KellerNanoParent::setup(void)
{
...
bool KellerNanoParent::addSingleMeasurementResult(void)
{
    bool success = false;

    // Initialize float variables
    float waterPressureBar = -9998;
    float waterTempertureC = -9998;
    float waterDepthM = -9998;
    float waterPressure_mBar = -9998;
