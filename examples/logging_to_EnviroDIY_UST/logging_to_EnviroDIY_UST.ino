...
const char *LoggerID = "Mayfly_170036";
// How frequently (in minutes) to log data
const uint8_t loggingInterval = 1;
// Your logger's timezone.
const int8_t timeZone = -6; //Central Standard Time = UTC-6, CDT = UTC-5
...
const int8_t OneWireBus = 10;  // Pin attached to the OneWire Bus (-1 if unconnected)
...
MaximDS18 ds18_u(OneWirePower, OneWireBus); //auto-detect OneWire address if only one sensor attached to pin
...
Variable *variableList[] = {
    new ProcessorStats_Batt(&mayfly, "3896874b-53f7-48cd-986d-9b88a79aeff5"),
    new ProcessorStats_FreeRam(&mayfly, "c7efbc9a-9e52-4dd0-8620-eeb1179bddc7"),
    new MaximDS3231_Temp(&ds3231, "e2b5fe67-827d-4498-b960-5ea27c6c073c"),
 /*COMMENT OUT CODE   
...
COMMENT IN CODE*/
    new MaximDS18_Temp(&ds18_u, "ab3276df-e733-47f8-95fd-e40af8604aac"), //manually paste UUID from data.enviroDIY here
 /*COMMENT OUT CODE   
...
// ==========================================================================
const char *REGISTRATION_TOKEN = "5a4d0a4d-411b-49cb-ba24-02aa35b8f058";   // Device registration token
const char *SAMPLING_FEATURE = "48818396-629c-401a-bc07-84aeba3a4602";     // Sampling feature UUID
const char *UUIDs[] =                                                      // UUID array for device sensors
{
    "3896874b-53f7-48cd-986d-9b88a79aeff5",   // Battery voltage (EnviroDIY_Mayfly_Batt)
    "c7efbc9a-9e52-4dd0-8620-eeb1179bddc7",   // Free SRAM (EnviroDIY_Mayfly_FreeRAM)
    "e2b5fe67-827d-4498-b960-5ea27c6c073c"    // Temperature (EnviroDIY_Mayfly_Temp)
    "ab3276df-e733-47f8-95fd-e40af8604aac",   // Temperature (Maxim_DS18B20_Temp)
};
...
comment in code*/
    ...
    EnviroDIYLogger.setSamplingFeatureUUID(SAMPLING_FEATURE);
