...
In the `Start [variable_arrays]` section, find and replace the text `"12345678-abcd-1234-ef00-1234567890ab"` with the UUIDs for each of your variables, if they have UUIDs.
Make sure there are quotation marks around the name string, as there are in the example.
