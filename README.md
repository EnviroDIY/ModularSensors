...
The main constructor for the sensor object is (called once each for high and low range):  Do NOT forget that if you want to give a number of measurements to average, that comes _after_ the i2c address in the constructor!
