 ...
 * @brief Adapted for for testing WiFi sites.
 *
 * This example shows proper settings for the following configuration:
 *
 * Mayfly v1.0 board
 * EnviroDIY or WiFi SIM7080 LTE module (with Hologram SIM card)
 *
...
void setup() {
    ...
    // How to turn of meta data dta polling modemPhy.updateModemMetadata(0);
    // Begin the logger
    dataLogger.begin();
