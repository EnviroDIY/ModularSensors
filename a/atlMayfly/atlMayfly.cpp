...
Written By:  Neil Hancock from great example by Sara Damiano (sdamiano@stroudcenter.org)
...
Variable *variableList[] = {
    ...
    new TIINA219M_Current(&ina219_phy, INA219_MA_UUID),
#endif
#if defined(INA219_VOLT_UUID)
    new TIINA219M_Volt(&ina219_phy, INA219_VOLT_UUID),
#endif
#ifdef SENSOR_CONFIG_GENERAL
