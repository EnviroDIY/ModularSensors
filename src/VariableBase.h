...
class Variable {
 public:
    ...
    // This is a helper - it returns the name of the parent sensor, if
    // applicable This is needed for dealing with variables in arrays
    String getParentSensorName(void);
    // This is a helper - it returns the name and location of the parent sensor,
    // if applicable This is needed for dealing with variables in arrays
    ...
    // This gets/sets the variable's unit using
