...
bool DigiXBeeCellularBypass::didATRespond(void)
{
...
// push data.
bool DigiXBeeCellularBypass::isMeasurementComplete(bool debug)
{
    #if defined MS_DIGIXBEECELLULARBYPASS_DEBUG
    debug = true;
    #endif
...
bool DigiXBeeCellularBypass::connectInternet(uint32_t maxConnectionTime)
{
    bool retVal = true;
...
uint32_t DigiXBeeCellularBypass::getNISTTime(void)
{
    ...
    connectionMade = _tinyClient->connect("time.nist.gov", 37);
