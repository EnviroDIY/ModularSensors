...
// Debugging Statement
// #define MS_NIMBELINKLTEMSEQUANS_DEBUG

#ifdef MS_NIMBELINKLTEMSEQUANS_DEBUG
...
#define TINY_GSM_MODEM_SEQUANS_MONARCH  // Select for a Sequans Monarch CAT-M1
