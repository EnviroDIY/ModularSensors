...
#define ATLAS_CO2_WARM_UP_TIME_MS 10000
#define ATLAS_CO2_STABILIZATION_TIME_MS 0
...
{
public:
    AtlasScientificCO2(int8_t powerPin, uint8_t i2cAddressHex = ATLAS_CO2_I2C_ADDR, uint8_t measurementsToAverage = 1)
     : AtlasParent(powerPin, i2cAddressHex, measurementsToAverage,
                    "AtlasScientificCO2", ATLAS_CO2_NUM_VARIABLES,
                    ATLAS_CO2_WARM_UP_TIME_MS, ATLAS_CO2_STABILIZATION_TIME_MS, ATLAS_CO2_MEASUREMENT_TIME_MS)
    {}
    ~AtlasScientificCO2(){}
};
...
public:
    AtlasScientificCO2_CO2(Sensor *parentSense,
      ...
      : Variable(parentSense, ATLAS_CO2_VAR_NUM,
                 "carbonDioxideDissolved", "partPerMillion",
