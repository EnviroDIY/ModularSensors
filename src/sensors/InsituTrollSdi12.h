...
public:
    ...
    InsituTrollSdi12(char SDI12address, int8_t powerPin, int8_t dataPin, uint8_t measurementsToAverage = 1)
     : SDI12Sensors(SDI12address, powerPin, dataPin, measurementsToAverage,
                    "InsituTrollSdi12", ITROLL_NUM_VARIABLES,
                    ITROLL_WARM_UP_TIME_MS, ITROLL_STABILIZATION_TIME_MS, ITROLL_MEASUREMENT_TIME_MS)
    {}
    InsituTrollSdi12(char *SDI12address, int8_t powerPin, int8_t dataPin, uint8_t measurementsToAverage = 1)
     : SDI12Sensors(SDI12address, powerPin, dataPin, measurementsToAverage,
                    "InsituTrollSdi12", ITROLL_NUM_VARIABLES,
                    ITROLL_WARM_UP_TIME_MS, ITROLL_STABILIZATION_TIME_MS, ITROLL_MEASUREMENT_TIME_MS)
    {}
    InsituTrollSdi12(int SDI12address, int8_t powerPin, int8_t dataPin, uint8_t measurementsToAverage = 1)
     : SDI12Sensors(SDI12address, powerPin, dataPin, measurementsToAverage,
                    "InsituTrollSdi12", ITROLL_NUM_VARIABLES,
                    ITROLL_WARM_UP_TIME_MS, ITROLL_STABILIZATION_TIME_MS, ITROLL_MEASUREMENT_TIME_MS)
    {}
...
{
public:
    InsituTrollSdi12_Temp(Sensor *parentSense,
                    const char *uuid = "",
                    const char *varCode = "ITROLLtemp")
      : Variable(parentSense,
                 (const uint8_t)ITROLL_TEMP_VAR_NUM,
...
{
public:
    InsituTrollSdi12_Depth(Sensor *parentSense,
                     const char *uuid = "",
