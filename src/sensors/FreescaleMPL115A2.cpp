...
MPL115A2::MPL115A2(TwoWire *theI2C, int8_t powerPin, uint8_t i2cAddressHex,
...
MPL115A2::MPL115A2(int8_t powerPin, uint8_t i2cAddressHex,
                   uint8_t measurementsToAverage)
  : Sensor("MPL115A2", MPL115A2_NUM_VARIABLES,
           MPL115A2_WARM_UP_TIME_MS, MPL115A2_STABILIZATION_TIME_MS, MPL115A2_MEASUREMENT_TIME_MS,
           powerPin, -1, measurementsToAverage)
...
bool MPL115A2::setup(void)
{
    ...
    mpl115a2_internal.begin(_i2cAddressHex, _i2c);
