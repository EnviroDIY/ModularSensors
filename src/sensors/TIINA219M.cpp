...
uint8_t TIINA219M::which_sensors_active() { return _ina219_pollmask; }
...
bool TIINA219M::addSingleMeasurementResult(void) {
  ...
  if (bitRead(_sensorStatus, 6)) {
    ...
    // Collect data - starting with BusVolatage as it has a check for Conversion
    // Ready.
...
// Az extensions
void TIINA219M::setCustomAmpMult(float newAmpMult) { _ampMult = newAmpMult; }

float TIINA219M::getCustomAmpMult(void) { return _ampMult; }
...
float TIINA219M::getCustomVoltThreshold(void) { return _voltLowThreshold_V; }