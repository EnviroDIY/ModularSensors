...
// no-cache"; const unsigned char *Smtp2goJsonPublisher::connectionHeader =
// "\r\nConnection: close";
const char* Smtp2goJsonPublisher::contentLengthHeader = "\r\nContent-Length: ";
const char* Smtp2goJsonPublisher::contentTypeHeader =
    "\r\nContent-Type: application/json\r\n\r\n";

// const char *Smtp2goJsonPublisher::samplingFeatureTag =
// "{\"sampling_feature\":\""; const char *Smtp2goJsonPublisher::timestampTag =
// "\",\"timestamp\":\"";
const char* Smtp2goJsonStr =
    "{\"api_key\":\"api-76228BACDD7511E99F26F23C91C88F4E\",\"sender\": "
    "\"neilhlow@sonic.com\",\"to\":[\"neilh@sonic.net\"],\"subject\":\"Test "
    "1745\",\"text_body\":\"Test body 1745\"}\0";

// Constructors
Smtp2goJsonPublisher::Smtp2goJsonPublisher() : dataPublisher() {
...
// This prints this samples data as formatted JSON for inclusion in a Smtp2go
// msg
...
#define MAX_TX_BUF_SZ 750  // DataPublisher
    if (Json_Length < MS_SEND_BUFFER_SIZE) {
        ...
        MS_DBG(F("ABORT Outgoing JSON size:"), calculateJsonSize(),
               F("Greater than buffer "), MAX_BUF_SZ);
        return 0;
    }
    ...
    if (_outClient->connect(Smtp2goJsonHost, Smtp2goJsonPort)) {
        ...
        // For ram limited systems, before adding each line/chunk to the
        // outgoing buffer, we make sure there is space for that line, sending
        // out buffer if not
...
#define HTTP_RESPONSE_TIMER 30000L
        ...
        PRINTOUT(F("\n -- Unable to Establish Connection to Smtp2goJson Data "
                   "Portal --"));
    }
