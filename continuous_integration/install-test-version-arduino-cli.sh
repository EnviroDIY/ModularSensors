...
if [ -z "${GITHUB_HEAD_REF}" ]; then
    echo "\n\e[36mExpected unzipped directory name (from commit SHA): home/arduino/downloads/ModularSensors-${GITHUB_SHA}\e[0m"
    ...
    echo "\n\e[36mExpected unzipped directory name (from head of ${GITHUB_HEAD_REF}): home/arduino/downloads/ModularSensors-${SAVED_ZIP_NAME}\e[0m"
    mv home/arduino/downloads/ModularSensors-${INTERNAL_ZIP_NAME}/* home/arduino/user/libraries/ModularSensors
fi
