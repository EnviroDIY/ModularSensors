...
// **Start Code for OLED display, via to the Mayfly's I2C Grove connector
...
void loop()
{
    ...
    delay(300);  // Published start-up time is 160ms;

    readMaxbotixHeader();
    int range = readMaxbotixData();
