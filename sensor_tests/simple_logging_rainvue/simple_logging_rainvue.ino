/** =========================================================================
 * @file simple_logging_rainvue.ino
 * @brief A simple data logging example for Campbell RainVUE10.
 *
...
// Mayfly 0.x D31 = A7; Mayfly 1.x = 31
...
const int8_t RainVUEPower       = -1;  // Power pin
const int8_t RainVUEData        = 5;               // The SDI-12 data pin
