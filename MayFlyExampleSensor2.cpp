...
#include <math.h>
#include "MayFlyExampleSensor2.h"
#define ANALOG_TEMP_PIN A5

MayFlyExampleSensor2::MayFlyExampleSensor2(void)
    : Sensor<float>("WindDir_Std")
{
    // Do nothing. Not because we can't, but we don't need to.
}

bool MayFlyExampleSensor2::update(void)
{
...
String MayFlyExampleSensor2::getValueAsString()
{
